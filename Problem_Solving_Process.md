...
(benpinzone.io/psp Redirects to this raw document on my git.)
========================================================================
...
Data Structures
    ...
    Sets-
        ...
        single (def) or multi
        Mind the STL functions: Intersection, difference, etc. (Apply to sorted vectors.)
    Maps-
        ordered (def) or unordered
        single (def) or multi
    Union-Find (Unifying Disjoint Sets)
    Pair - Auto sorts by first, then second.
    Graphs
...
Algorithm Families
    ...
    Divide and Conquer
        ...
        Dynamic Programming - Overlapping sub-problems
            Must be able to form an optimal solution out of optimal sub-solutions.
...
Stuck?
    ...
    Which populated data structure(s) do I wish I had?
        ie If you had this structure, the problem would be trivial.
...
Misc
    Algorithm vs Properties vs Counting
        If you're asked about the existence of a solution or the value of some property (count the number of swaps necessary, etc), keep in mind you probably won't need to write the entire algorithm that would actually determine that result. Just some theoretical analysis.
            Use counting techniques, set theory, etc.
    Once you have the main idea and you are confident in the algorithm, DO NOT forget to work out all minute details.
        BE the computer. Be the compiler.
            Forget what the code is supposed to do. See what it does.
    Just try something.
...
Don't be blind
    ...
    What language subtleties might I correct?
        (ie access modifiers, inline statics)
...
Bridging the Gap
    ...
    What additional basic information could I compute easily?
        (ie try counting things, running all your data through any functions provided.)
    ...
    What do I wish I had? (ie if I had a structure populated with this data, the problem is done.)
        ie If you had this structure, the problem would be trivial.
    ...
    What is really going on here, fundamentally?
        If you are given some entity/function, ask- What IS this, fundamentally?
            Is there a superfluous transformation going on?
                ie: Something may just be a saturating counter, decoder, or mux.
...
TODO:
    Identify 3-5 critical pieces:
        1. Actively identify any bad assumptions you may have made unintentionally.
    ...
    General
        ...
        Clarity of Design
            ...
            When you need clarity, think only of fundamental definitions of:
                1. your tools
                2. the fundamental desired outcome of what you are building.
